...
if __name__ == '__main__':
    ...
    group_additional.add_argument('--min_x', type=int, help="min_x value", default=None)
    group_additional.add_argument('--max_x', type=int, help="max_x value", default=None)
    group_additional.add_argument('--min_y', type=int, help="min_y value", default=None)
    group_additional.add_argument('--max_y', type=int, help="max_y value", default=None)
    group_additional.add_argument('--xlabel', type=int, help="xlabel", default=None)
    group_additional.add_argument('--ylabel', type=int, help="ylabel", default=None)
    group_additional.add_argument('--title', type=int, help="title", default=None)
